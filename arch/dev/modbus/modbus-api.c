...
{
  return modbusRespErrorsVerify(responsePacket, byteCount, exceptionCode, hasCrc);
}
/********************************************************************/
int16_t
modbus_get_int16(unsigned char first , unsigned char second) {
  uint16_t value;
