...
#define SNR_TLE_TEMPERATURE_POINT 0x08
#define SNR_TLE_TEMPERATURE_ALARM 0x09
#define SNR_TLE_LED_FORECE 		0x0A
#define SNR_TLE_BUZZ_FORCE 		0x0B
#define SNR_TLE_S7S_FORCE 		0x0C
#define SNR_TLE_S7S_VALUE 		0x0D
